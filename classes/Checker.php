...
class Checker {
    ...
    public function check_email_form() {
        if ( self::check_email() ) Routing::redirect('register', Error::ERR_REGISTER_EMAIL_FORM);
    }

    public function check_passwords_match() {
        if ( strcmp($this->pass1, $this->pass2) != 0 ) Routing::redirect('register', Error::ERR_REGISTER_PASS_MATCH);
    }
